                  ...
                  <div className="p-4">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-bold text-green-600">
                        Rp {(product.hargaPerTon * product.jumlahKarbon).toLocaleString()}
                      </p>
                    </div>
                    <div className="mt-2">
                      <span className="text-sm text-gray-500">Jumlah Sertifikat:</span>
                      <p className="font-medium">{product.jumlahKarbon} Sertifikat</p>
                    </div>
